...
class FinalTripLogsFix extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Ensure trip_logs table exists first
        ...
        // Add fuel_consumed FIRST - this is what's causing the error
        if (Schema::hasTable('trip_logs') && !Schema::hasColumn('trip_logs', 'fuel_consumed')) {
