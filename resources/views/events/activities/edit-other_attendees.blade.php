        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    ...
                    @endif
                    {!! Form::model($activity, array('route' => array($route, $activity->id), 'method' => 'post', 'class'=> 'form-vertical form-material', 'enctype="multipart/form-data"')) !!}
                    <div class="row">
                        <div class="col-md-5">
             ...
             <div id="gallery">
                <div id="gallery-content">
                    <div id="gallery-content-center">
                        ...
                        <a href="{{asset('storage/'.$photo->path) }}" data-toggle="lightbox" data-effect="mfp-zoom-in" data-gallery="multiimages" data-title="{{$participant->name}}"><img src="{{ asset('storage/'.$photo->path) }}" alt="gallery" class="all studio" /></a>
