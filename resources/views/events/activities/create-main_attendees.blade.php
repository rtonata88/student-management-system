        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title">{{$activity_title}} / <span class="text-muted">{{$profile->lastname}} {{$profile->fullname}}</span></h3>
                   {!! Form::open(array('route' => array('main_attendees.activityReport', $activity_type, $profile->slug, $event->slug), 'method' => 'post', 'class'=> 'form-vertical form-material', 'enctype="multipart/form-data"')) !!}
                    <div class="row">
                        <div class="col-md-5">
