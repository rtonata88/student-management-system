...
<div class="c-subheader px-3">
    ...
    <li class="breadcrumb-item active"><a href="/events">Internal events </a></li>
    <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
...
<div class="card">
    <div class="card-header">
        <div class="float-left">
            <a href="/events/create" class="btn btn-primary pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><span class="fa fa-plus"></span> CREATE EVENT</a>
        </div>
    </div>
    <div class="card-body">
