    ...
    <div class="row bg-title">
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title">Document [Update]</h3>
                    @if ($errors->any())
                    ...
                    @endif
                <hr>
                {!! Form::model($documentation, array('route'=>array('documentation.update', $documentation->id), 'class'=>'form-vertical form-material', 'method'=>'PATCH', 'enctype="multipart/form-data"')) !!}
                <div class="row">
