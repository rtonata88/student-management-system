...
<div class="c-subheader px-3">
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active"><a href="/enrolment">Assessment Types</a></li>
        <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
    ...
    <div class="offset-2 col-md-8">
        ...
        <div class="card">
            <div class="card-header">
                <strong>Select Subject to create assessment types</strong>
            </div>
            <div class="card-body">
                <table class="table table-responsive-sm table-bordered table-striped table-sm" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/assessment-types/{{$subject->id}}">
                                    View
