            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="mb-0">Capture {{ $assessmentType->name }} marks.</h4>
                        </div>
                ...
                <div class="card-body">
                            ...
                            <form method="GET">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('test-marks.capture', [$module->id, $centre->id, $assessmentType->id]) }}" class="btn btn-secondary">
                    ...
                    @if($students->count() > 0)
                        <form method="POST" action="{{ route('test-marks.store', [$module->id, $centre->id, $assessmentType->id]) }}">
                            @csrf
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach($students as $student)
                                            @php
                                                $existingMark = $student->testMarks->first();
                                            @endphp
                                            <tr>
