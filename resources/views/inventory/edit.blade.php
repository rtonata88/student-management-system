    ...
    <div class="col-md-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                ...
                <small class="text-muted">Update inventory item details for {{ $inventory->name }}</small>
            </div>
            <div class="card-body">
                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="unit_cost" name="unit_cost" 
                                           value="{{ old('unit_cost', $inventory->unit_cost) }}" step="0.01" min="0" required>
                                </div>
                            </div>

                            <div class="alert alert-info">
                                <strong>Current Stock:</strong> {{ $inventory->quantity_in_stock }} {{ $inventory->unit_of_measure }}
                                <br><small>Use "Adjust Stock" or "Stock Movement" to change quantities</small>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="minimum_stock_level" name="minimum_stock_level" 
                                               value="{{ old('minimum_stock_level', $inventory->minimum_stock_level) }}" min="0" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="maximum_stock_level" name="maximum_stock_level" 
                                               value="{{ old('maximum_stock_level', $inventory->maximum_stock_level) }}" min="0">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="specifications" name="specifications" rows="4" 
                                          placeholder='{"color": "blue", "size": "large", "material": "plastic"}'>{{ old('specifications', $inventory->specifications ? json_encode($inventory->specifications, JSON_PRETTY_PRINT) : '') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('inventories.index') }}" class="btn btn-outline-secondary">
                                    <svg class="c-icon c-icon-sm mr-1">
                                        <use xlink:href="{{asset('new/node_modules/@coreui/icons/sprites/free.svg#cil-list')}}"></use>
                                    </svg>
                                    Back to List
                                </a>
                            </div>
