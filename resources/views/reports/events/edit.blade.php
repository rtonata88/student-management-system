        ...
        <div class="panel panel-default">
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            <td width="390"><strong>{{$participant->fullname}}</strong></td>
                    ...
                    <p>
                        sss
                        <div class="panel panel-default summary-feedback" style=" border: 1px solid #ddd">
                            <div class="panel-heading" style="background-color: #f5f5f5;"><strong>SUMMARY OUTCOME</strong></div>
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    ...
                    @foreach($event->guest_register() as $register)
                    @if(!is_null($register->profile_id))
                    <div class="panel panel-default detailed-feedback" style=" border: 1px solid #ddd">
                        <div class="panel-heading" style="background-color: #f5f5f5;"><strong>{{strtoupper($register->fullname)}} {{strtoupper($register->lastname)}}</strong></div>
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                ...
                <div class="panel panel-default" style=" border: 1px solid #ddd">
                    <div class="panel-heading" style="background-color: #f5f5f5;"><strong>STRENGTHS</strong></div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <p>
                                <textarea class="form-control summernote" rows="10" name="strengths">{{$report_config->strengths}}</textarea>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default" style=" border: 1px solid #ddd">
                    <div class="panel-heading" style="background-color: #f5f5f5;"><strong>WEAKNESSES</strong></div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <p>
                                <textarea class="form-control summernote" rows="10" name="weaknesses">{{$report_config->weaknesses}}</textarea>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default" style=" border: 1px solid #ddd">
                    <div class="panel-heading" style="background-color: #f5f5f5;"><strong>OPPORTUNITIES</strong></div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <p>
                                <textarea class="form-control summernote" rows="10" name="opportunities">{{$report_config->opportunities}}</textarea>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default" style=" border: 1px solid #ddd">
                    <div class="panel-heading" style="background-color: #f5f5f5;"><strong>THREATS</strong></div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <p>
                                <textarea class="form-control summernote" rows="10" name="threats">{{$report_config->threats}}</textarea>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-heading" style="background-color: #f5f5f5;">{{$misc->title}}
                        <div class="panel-action">
                          <div class="checkbox checkbox-success">
                            <input  type="checkbox" name="misc[{{$misc->id}}]" @if($report_config->is_included($misc->id, $report_config->id)) checked @endif>
