                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $examination->name) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" class="form-control" value="{{ old('code', $examination->code) }}" required maxlength="10" style="text-transform: uppercase;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="mark_cap" id="mark_cap" class="form-control" value="{{ old('mark_cap', $examination->mark_cap) }}" required min="0" max="100" step="0.01">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-check mt-4">
                                    <input type="checkbox" name="active" id="active" class="form-check-input" value="1" {{ old('active', $examination->active) ? 'checked' : '' }}>
