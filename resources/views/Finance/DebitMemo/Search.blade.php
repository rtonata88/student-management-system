        ...
        <div class="search-card">
            <div class="search-header">
                <h4 class="search-title">
                    ...
                    Find Student for Debit Memo
                </h4>
                <p class="search-subtitle">Search by student number or name to create debit memo</p>
            </div>
            
            {!! Form::open(array('route' => array('debit-memos.filter'), 'method' => 'post', 'class'=> 'search-form')) !!}
