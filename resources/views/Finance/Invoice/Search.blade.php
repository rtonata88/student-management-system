        ...
        <div class="search-card">
            <div class="search-header">
                <h4 class="search-title">
                    ...
                    Find Student for Invoice
                </h4>
                <p class="search-subtitle">Search by student number or name to view invoices</p>
            </div>
            
            {!! Form::open(array('route' => array('invoices.filter'), 'method' => 'post', 'class'=> 'search-form')) !!}
