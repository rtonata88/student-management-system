...
<div class="c-subheader px-3">
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ ucwords(str_replace('_', ' ', $letterType)) }}</li>
        <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div style="margin-bottom: 30px; text-align: justify; line-height: 1.8; text-indent: 30px;">
                            {{ $letterContent }}
                        </div>
                        
                        <div style="background: #f8f9fa; padding: 15px; border-left: 4px solid #007bff; margin-bottom: 30px;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50%; text-align: center;">
                                        <div style="border: 2px dashed #ccc; border-radius: 50%; width: 120px; height: 120px; display: inline-flex; align-items: center; justify-content: center; background: #f8f9fa;">
                                            <div style="font-size: 12px; font-weight: bold; color: #999; text-align: center; line-height: 1.2;">
                                                OFFICIAL<br>STAMP
                                            </div>
                                        </div>
                                    </td>
