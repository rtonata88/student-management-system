    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Payroll Period</h5>
                <small class="text-muted">Update payroll processing period details</small>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                {!! Form::model($period, ['route' => ['payroll.periods.update', $period], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{Form::date('start_date', $period->start_date ? $period->start_date->format('Y-m-d') : null, ['class' => 'form-control', 'required'])}}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {{Form::label('end_date', 'End Date')}}
                            {{Form::date('end_date', $period->end_date ? $period->end_date->format('Y-m-d') : null, ['class' => 'form-control', 'required'])}}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    {{Form::date('pay_date', $period->pay_date ? $period->pay_date->format('Y-m-d') : null, ['class' => 'form-control', 'required'])}}
