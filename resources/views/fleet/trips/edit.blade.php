        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-route"></i> Edit Trip
                    </h3>
                ...
                <form action="{{ route('fleet.trips.update', $trip) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="trip_purpose" id="trip_purpose" class="form-control" required>
                                        ...
                                        <option value="student_transport" {{ old('trip_purpose', $trip->trip_purpose) == 'student_transport' ? 'selected' : '' }}>Student Transport</option>
                                        <option value="staff_transport" {{ old('trip_purpose', $trip->trip_purpose) == 'staff_transport' ? 'selected' : '' }}>Staff Transport</option>
                                        <option value="field_trip" {{ old('trip_purpose', $trip->trip_purpose) == 'field_trip' ? 'selected' : '' }}>Field Trip</option>
                                        <option value="maintenance" {{ old('trip_purpose', $trip->trip_purpose) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                                        <option value="emergency" {{ old('trip_purpose', $trip->trip_purpose) == 'emergency' ? 'selected' : '' }}>Emergency</option>
                                        <option value="other" {{ old('trip_purpose', $trip->trip_purpose) == 'other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="destination" id="destination" class="form-control" 
                                           value="{{ old('destination', $trip->destination) }}" placeholder="Enter destination address" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="departure_time" id="departure_time" class="form-control" 
                                           value="{{ old('departure_time', $trip->departure_time ? \Carbon\Carbon::parse($trip->departure_time)->format('Y-m-d\TH:i') : '') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="expected_return_time" id="expected_return_time" class="form-control" 
                                           value="{{ old('expected_return_time', $trip->expected_return_time ? \Carbon\Carbon::parse($trip->expected_return_time)->format('Y-m-d\TH:i') : '') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="arrival_time">Actual Arrival Time</label>
                                    <input type="datetime-local" name="arrival_time" id="arrival_time" class="form-control" 
                                           value="{{ old('arrival_time', $trip->arrival_time ? \Carbon\Carbon::parse($trip->arrival_time)->format('Y-m-d\TH:i') : '') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="passenger_count" id="passenger_count" class="form-control" 
                                           value="{{ old('passenger_count', $trip->passenger_count) }}" placeholder="e.g., 25" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="odometer_start" id="odometer_start" class="form-control" 
                                           value="{{ old('odometer_start', $trip->odometer_start) }}" placeholder="e.g., 15000" min="0" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="odometer_end">Ending Odometer Reading (km)</label>
                                    <input type="number" name="odometer_end" id="odometer_end" class="form-control" 
                                           value="{{ old('odometer_end', $trip->odometer_end) }}" placeholder="e.g., 15050" min="0">
                                    <small class="text-muted">Automatically calculated from liters × price per liter to starting odometer</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="distance_km">Actual Distance (km)</label>
                                    <input type="number" name="distance_km" id="distance_km" class="form-control" 
                                           value="{{ old('distance_km', $trip->distance_km) }}" placeholder="Auto-calculated from odometer" min="0" step="0.1">
                                    <small class="text-muted">Automatically calculated from odometer readings (can be manually adjusted)</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fuel_consumed" id="fuel_consumed" class="form-control" 
                                           value="{{ old('fuel_consumed', $trip->fuel_consumed) }}" placeholder="e.g., 5.5" min="0" step="0.1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="route_taken">Route Taken</label>
                                    <input type="text" name="route_taken" id="route_taken" class="form-control" 
                                           value="{{ old('route_taken', $trip->route_taken) }}" placeholder="e.g., Main Street -> Highway 1 -> School">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="estimated_distance">Estimated Distance (km)</label>
                                    <input type="number" name="estimated_distance" id="estimated_distance" class="form-control" 
                                           value="{{ old('estimated_distance', $trip->estimated_distance) }}" placeholder="e.g., 25" min="0" step="0.1">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="fuel_type" name="fuel_type">
                                        ...
                                        <option value="petrol" {{ old('fuel_type', $trip->fuel_type) == 'petrol' ? 'selected' : '' }}>Petrol</option>
                                        <option value="diesel" {{ old('fuel_type', $trip->fuel_type) == 'diesel' ? 'selected' : '' }}>Diesel</option>
                                        <option value="cng" {{ old('fuel_type', $trip->fuel_type) == 'cng' ? 'selected' : '' }}>CNG</option>
                                        <option value="electric" {{ old('fuel_type', $trip->fuel_type) == 'electric' ? 'selected' : '' }}>Electric</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fuel_liters" id="fuel_liters" class="form-control" 
                                           value="{{ old('fuel_liters', $trip->fuel_liters) }}" placeholder="e.g., 50" min="0" step="0.1">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price_per_liter" id="price_per_liter" class="form-control" 
                                               value="{{ old('price_per_liter', $trip->price_per_liter) }}" placeholder="e.g., 1.50" min="0" step="0.001">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="total_fuel_cost" id="total_fuel_cost" class="form-control" 
                                               value="{{ old('total_fuel_cost', $trip->total_fuel_cost) }}" placeholder="Auto-calculated" min="0" step="0.01" readonly>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fuel_station" id="fuel_station" class="form-control" 
                                           value="{{ old('fuel_station', $trip->fuel_station) }}" placeholder="e.g., Shell, BP, Total">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fuel_town_city" id="fuel_town_city" class="form-control" 
                                           value="{{ old('fuel_town_city', $trip->fuel_town_city) }}" placeholder="e.g., Windhoek, Swakopmund">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="receipt_number" id="receipt_number" class="form-control" 
                                           value="{{ old('receipt_number', $trip->receipt_number) }}" placeholder="e.g., RCP123456">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if($trip->fuel_receipt_path)
                                        <br><small class="text-success">Current file: {{ basename($trip->fuel_receipt_path) }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control" rows="3" 
                                              placeholder="Any additional notes...">{{ old('notes', $trip->notes) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    function calculateDistance() {
        ...
        // Only auto-calculate if distance field is empty or user hasn't manually entered a value
        var currentDistance = $('#distance_km').val();
        var shouldCalculate = !currentDistance || $('#distance_km').data('auto-calculated') !== false;
        
        if (startOdometer > 0 && endOdometer > 0 && endOdometer >= startOdometer && shouldCalculate) {
            var distance = endOdometer - startOdometer;
            $('#distance_km').val(distance.toFixed(1));
            $('#distance_km').data('auto-calculated', true);
        }
    }
    ...
    // Track manual changes to distance field
    $('#distance_km').on('input change', function() {
        if ($(this).val()) {
            $(this).data('auto-calculated', false);
        }
    });
    
    // Track manual changes to fuel cost field
    $('#total_fuel_cost').on('input change', function() {
        if ($(this).val()) {
            $(this).data('auto-calculated', false);
        }
    });
    ...
    var initialDistance = $('#distance_km').val();
    if (initialDistance) {
        $('#distance_km').data('auto-calculated', false);
    }
    
    calculateDistance();
    validateEndingOdometer();
    
    // Set initial min value for ending odometer
    var initialStart = $('#odometer_start').val();
    if (initialStart) {
        $('#odometer_end').attr('min', initialStart);
    }
});
</script>
@endsection
