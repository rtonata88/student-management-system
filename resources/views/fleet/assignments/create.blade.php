        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user-cog"></i> Create Vehicle Assignment
                    </h3>
                ...
                <div class="card-body">
                    <form action="{{ route('fleet.assignments.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="assignment_type" id="assignment_type" class="form-control @error('assignment_type') is-invalid @enderror" required>
                                        ...
                                        <option value="primary" {{ old('assignment_type') == 'primary' ? 'selected' : '' }}>Primary Driver</option>
                                        <option value="secondary" {{ old('assignment_type') == 'secondary' ? 'selected' : '' }}>Secondary Driver</option>
                                        <option value="temporary" {{ old('assignment_type') == 'temporary' ? 'selected' : '' }}>Temporary Assignment</option>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror" placeholder="Additional notes about this assignment">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
