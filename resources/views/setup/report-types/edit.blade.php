    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">{{$report_type->name}} [update]</h3>
                     {!! Form::model($report_type, array('route'=>array('report-types.show', $report_type->id), 'class'=>'form-horizontal', 'method'=>'PATCH')) !!}
