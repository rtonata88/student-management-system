    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <a href="/teams"> <span class="fa fa-arrow-circle-left"></span> Back</a>
                    <h3 class="box-title">SECTOR TEAM [NEW]</h3>
                    @if ($errors->any())
                    ...
                    @endif
                     ...
                     {!! Form::open(array('url' => '/teams', 'method' => 'post', 'class'=> 'form-horizontal')) !!}
