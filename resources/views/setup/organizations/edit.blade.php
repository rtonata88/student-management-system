    ...
    <div class="col-md-8 col-xs-12">
        <div class="card">
            ...
            <div class="card-body">
              ...
              {!! Form::model($organization, array('route'=>array('organizations.show', $organization->slug), 'class'=>'form-horizontal', 'method'=>'PATCH')) !!}                <table class="table table-responsive-sm table-bordered table-sm" style="width:100%">
                <tr>
