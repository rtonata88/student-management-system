    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <a href="/fruit-roles"> <span class="fa fa-arrow-circle-left"></span> Back</a>
                    <h3 class="box-title">FRUIT ROLE [NEW]</h3>
                    @if ($errors->any())
                    ...
                    @endif
                     ...
                     {!! Form::open(array('url' => '/fruit-roles', 'method' => 'post', 'class'=> 'form-horizontal')) !!}
