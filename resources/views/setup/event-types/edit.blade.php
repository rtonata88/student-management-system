    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">{{$event_type->name}} [update]</h3>
                     {!! Form::model($event_type, array('route'=>array('event-types.show', $event_type->id), 'class'=>'form-horizontal', 'method'=>'PATCH')) !!}
                        <div class="form-group">
                          <div class="col-md-5">
                            {{Form::label('type', 'Event Type Name')}}
