    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">{{$meeting_type->name}} [update]</h3>
                     {!! Form::model($meeting_type, array('route'=>array('meeting-types.show', $meeting_type->slug), 'class'=>'form-horizontal', 'method'=>'PATCH')) !!}
