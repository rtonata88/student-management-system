    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <a href="/meeting-types"> <span class="fa fa-arrow-circle-left"></span> Back</a>
                    <h3 class="box-title">MEETING TYPE [NEW]</h3>
                    @if ($errors->any())
                    ...
                    @endif
                     ...
                     {!! Form::open(array('url' => '/meeting-types', 'method' => 'post', 'class'=> 'form-horizontal')) !!}
                        <div class="form-group">
                          <div class="col-md-5">
                            {{Form::label('type', 'Meeting Type')}}
