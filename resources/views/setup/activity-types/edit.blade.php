    ...
    <div class="row bg-title">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">FRUIT ACTIVITY TYPES [update]</h3>
                     {!! Form::model($activity_type, array('route'=>array('activity-types.show', $activity_type->id), 'class'=>'form-horizontal', 'method'=>'PATCH')) !!}
