        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    @endpermission
                    <a href="/academic-year" class="btn" style="background: linear-gradient(135deg, #6f42c1 0%, #007bff 100%); color: white; border: none; border-radius: 6px; padding: 0.375rem 0.75rem;"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
