...
<div class="c-subheader px-3">
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Edit Module Allocation</li>
    </ol>
</div>
@endsection
        ...
        <div class="search-container">
            <div class="search-card">
                ...
                <div class="search-form">
                    ...
                    <form action="{{ route('module-allocations.update', $allocation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="module_id" id="module_id" class="form-control" required>
                                ...
                                <option value="{{ $module->id }}" {{ (old('module_id', $allocation->subject_id) == $module->id) ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select name="academic_year_id" id="academic_year_id" class="form-control" required>
                                ...
                                <option value="{{ $year->id }}" {{ (old('academic_year_id', $allocation->academic_year_id) == $year->id) ? 'selected' : '' }}>
                                    {{ $year->academic_year }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="center_id" id="center_id" class="form-control" required>
                                ...
                                <option value="{{ $center->id }}" {{ (old('center_id', $allocation->center_id) == $center->id) ? 'selected' : '' }}>
                                    {{ $center->center_name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="teacher_id" id="teacher_id" class="form-control" required>
                                ...
                                <option value="{{ $teacher->id }}" {{ (old('teacher_id', $allocation->user_id) == $teacher->id) ? 'selected' : '' }}>
                                    {{ $teacher->name }}
                                </option>
                                @endforeach
                            </select>
