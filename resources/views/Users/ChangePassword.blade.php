    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-key"></i> Change Password for {{ $user->name }}</h5>
            ...
            <div class="card-body">
                            ...
                            <div class="card-body py-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <p class="mb-0"><i class="fas fa-envelope text-muted"></i> Email: {{ $user->email }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form method="POST" action="{{ route('users.update-password', $user->username) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group text-center mt-4">
                        ...
                        <a href="{{ route('users.index') }}" class="btn btn-outline-secondary" style="border-radius: 6px; padding: 0.375rem 1.5rem;">
