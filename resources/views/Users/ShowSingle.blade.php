    ...
    <div class="offset-2 col-sm-12 col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="/users" class="btn" style="background: linear-gradient(135deg, #6f42c1 0%, #007bff 100%); color: white; border: none; border-radius: 6px; padding: 0.375rem 0.75rem;"> Back</a>
            </div>
        </div>
    </div>
</div>
