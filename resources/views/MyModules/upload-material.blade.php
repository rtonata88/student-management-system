...
<div class="c-subheader px-3">
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('my-modules.subject-materials', $allocation->id) }}">Subject Materials</a></li>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-cloud-upload-alt"></i> Upload Subject Material
                </h5>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('my-modules.store-material', $allocation->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="document_description" name="document_description" 
                                  rows="3" placeholder="Optional description of the material content">{{ old('document_description') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="published" name="published" required>
                            <option value="1" {{ old('published', '1') == '1' ? 'selected' : '' }}>Yes - Make available to students</option>
                            <option value="0" {{ old('published') == '0' ? 'selected' : '' }}>No - Keep as draft</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            Supported formats: PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, TXT, JPG, JPEG, PNG (Max: 10MB)
                        </small>
                    </div>

                    <div class="form-group text-right">
                        <a href="{{ route('my-modules.subject-materials', $allocation->id) }}" 
