        ...
        <div class="search-card">
            <div class="search-header">
                <h4 class="search-title">
                    ...
                    Find Student to Cancel
                </h4>
                <p class="search-subtitle">Search by student number or name to cancel registration</p>
            </div>
            
            {!! Form::open(array('route' => array('cancel-registration.filter'), 'method' => 'post', 'class'=> 'search-form')) !!}
