...
<div class="c-subheader px-3">
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active"><a href="/enrolment">Enrolment Adjustment</a></li>
        <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
    ...
    <div class="search-container mb-5">
        <div class="search-card">
            <div class="search-header">
                ...
                <p class="search-subtitle">Search by student number or name to modify registration</p>
            </div>
            
            {!! Form::open(array('route' => array('enrolment.adjustment.filter'), 'method' => 'post', 'class'=> 'search-form')) !!}
