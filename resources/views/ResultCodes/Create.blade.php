...
<div class="c-subheader px-3">
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Add New Result Code</li>
        <!-- Breadcrumb Menu-->
    </ol>
</div>
@endsection
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <strong>Add New Result Code</strong>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('result-codes.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="pass_fail" id="pass_fail" class="form-control" required>
                                    ...
                                    <option value="Pass" {{ old('pass_fail') == 'Pass' ? 'selected' : '' }}>Pass</option>
                                    <option value="Fail" {{ old('pass_fail') == 'Fail' ? 'selected' : '' }}>Fail</option>
                                </select>
